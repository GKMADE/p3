...
static int mmc_schedule_delayed_work(struct delayed_work *work,
				     unsigned long delay)
{
	wake_lock_timeout(&mmc_delayed_work_wake_lock,HZ*10);
...
/* sean+: 20110115: wait_for_completion to wait_for_completion_timeout */
int mmc_wait_for_req_timeout(struct mmc_host *host, struct mmc_request *mrq, int timeout)
{
	int ret;
	DECLARE_COMPLETION_ONSTACK(complete);
...
EXPORT_SYMBOL(mmc_wait_for_req_timeout);
/* sean-: 20110115: wait_for_completion to wait_for_completion_timeout */
